                                        ...
                                        <td className="py-4 px-5 text-right">
                                            <div className="flex items-center justify-end space-x-1.5">
                                                <a
                                                    ...
                                                    className="px-2.5 py-1.5 rounded-xl bg-slate-100 hover:bg-emerald-600 hover:text-white text-slate-700 font-bold transition-colors inline-flex items-center space-x-1 cursor-pointer"
                                                >
                            ...
                            <div className="space-y-3.5 text-xs">
                                ...
                                <div className="pt-2 flex flex-col sm:flex-row items-center justify-between gap-2">
                                    <div className="flex items-center space-x-2 w-full sm:w-auto">
                                        <Link
                                            href="/dashboard/my-products"
                                            className="px-4 py-2.5 rounded-xl bg-blue-50 hover:bg-blue-100 text-[#2563EB] font-bold transition-colors text-center"
                                        >
                                            Buka Aset Unduhan
                                        </Link>
                                        <a
                                            href={`/orders/${selectedOrder.orderNumber}/invoice`}
                                            target="_blank"
                                            rel="noreferrer"
                                            className="px-4 py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-bold transition-colors inline-flex items-center space-x-1.5"
                                        >
                                            <Download className="w-3.5 h-3.5" />
                                            <span>Unduh PDF</span>
                                        </a>
